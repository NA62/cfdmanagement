//
// File generated by rootcint at Wed Sep 10 13:56:24 2014
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CFD_MainFrame*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("CFD_MainFrame", ::CFD_MainFrame::Class_Version(), "./include/CFD_MainFrame.h", 19,
...
atomic_TClass_ptr CFD_MainFrame::fgIsA(0);  // static to hold class pointer
...
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::CFD_MainFrame*)0x0)->GetClass();} }
   return fgIsA;
}
...
extern "C" void G__set_cpp_environmentCFD_Frame_Dict() {
  ...
  G__add_compiledheader("include/CFD_MainFrame.h");
...
static int G__CFD_Frame_Dict_189_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   G__va_arg_put(&G__va_arg_bufobj, libp, 2);
      ((CFD_MainFrame*) G__getstructoffset())->EmitVA((const char*) G__int(libp->para[0]), (Int_t) G__int(libp->para[1]), G__va_arg_bufobj);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
static void G__setup_memvarCFD_MainFrame(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__CFD_Frame_DictLN_TClass),G__defined_typename("atomic_TClass_ptr"),-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
